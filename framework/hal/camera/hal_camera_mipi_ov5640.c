...
AT_NONCACHEABLE_SECTION_ALIGN(
    static uint8_t s_cameraBuffer[CAMERA_DEV_MipiOv5640_BUFFER_COUNT][CAMERA_DEV_MipiOv5640_HEIGHT]
                                 [CAMERA_DEV_MipiOv5640_WIDTH * CAMERA_DEV_MipiOv5640_BPP],
...
void MipiOv5640_InitMipiCsi(void)
{
    ...
    {
        if ((FSL_VIDEO_RESOLUTION(CAMERA_DEV_MipiOv5640_WIDTH, CAMERA_DEV_MipiOv5640_HEIGHT) == csi2rxHsSettle[i][0]) &&
    ...
    camera_dev_t *dev, int width, int height, camera_dev_callback_t callback, void *param)
{
    ...
    dev->config.pitch  = CAMERA_DEV_MipiOv5640_WIDTH * CAMERA_DEV_MipiOv5640_BPP;
    ...
    cameraConfig.bytesPerPixel = CAMERA_DEV_MipiOv5640_BPP;
    cameraConfig.resolution    = FSL_VIDEO_RESOLUTION(CAMERA_DEV_MipiOv5640_WIDTH, CAMERA_DEV_MipiOv5640_HEIGHT);
    cameraConfig.frameBufferLinePitch_Bytes = CAMERA_DEV_MipiOv5640_WIDTH * CAMERA_DEV_MipiOv5640_BPP;
...
hal_camera_status_t HAL_CameraDev_MipiOv5640_Dequeue(const camera_dev_t *dev, void **data, pixel_format_t *format)
{
    ...
    *format = CAMERA_DEV_MipiOv5640_FORMAT;
    LOGI("--HAL_CameraDev_MipiOv5640_Dequeue");
    return ret;
}
...
static camera_dev_t camera_dev_mipi_ov5640 = {
    ...
    .config =
        {
            .height   = CAMERA_DEV_MipiOv5640_HEIGHT,
            .width    = CAMERA_DEV_MipiOv5640_WIDTH,
            .pitch    = CAMERA_DEV_MipiOv5640_WIDTH * CAMERA_DEV_MipiOv5640_BPP,
            .left     = CAMERA_DEV_MipiOv5640_LEFT,
            .top      = CAMERA_DEV_MipiOv5640_TOP,
            .right    = CAMERA_DEV_MipiOv5640_RIGHT,
            .bottom   = CAMERA_DEV_MipiOv5640_BOTTOM,
...
{
    int error = 0;
    LOGD("HAL_CameraDev_MipiOv5640_Register");
