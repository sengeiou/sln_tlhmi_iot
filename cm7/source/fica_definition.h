...
#define FICA_IMG_BOOTLOADER_SIZE (0x00000000) /* 1.00 MB */
#endif
...
#define FICA_IMG_RESOURCE_SIZE (0x800000)
...
#define FICA_IMG_RESOURCE_ADDR      (FICA_IMG_FILE_SYS_ADDR + FICA_FILE_SYS_SIZE)
#define FICA_FREE_MEM_START_ADDR    (FICA_IMG_RESOURCE_ADDR + FICA_IMG_RESOURCE_SIZE)
